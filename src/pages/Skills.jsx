      ...
      <div className="relative z-20 max-w-8xl mx-auto px-4 py-12 mt-10 space-y-12 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8 text-center">
          <h2 className="text-cyan-400 text-xl sm:text-2xl font-semibold text-center relative my-10">
            <span className="relative z-10 px-4 bg-dark text-3xl font-bold">My Skills</span>
            <span className="absolute left-0 top-1/2 w-1/3 h-px bg-cyan-400 transform -translate-y-1/2"></span>
            <span className="absolute right-0 top-1/2 w-1/3 h-px bg-cyan-400 transform -translate-y-1/2"></span>
          </h2>

          <p className="text-lg text-gray-300">
            A blend of modern web technologies and development skills that I
            master to build high-quality applications.
          </p>
        </div>
